...
// 背景图片
var background_img = "./img/background1.jpg"
...
function init_config() {
    ...
    // 设置背景图片
    document.getElementById('background').style.background = 'url(' + background_img + ') center center no-repeat'
